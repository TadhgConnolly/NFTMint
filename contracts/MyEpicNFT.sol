...
"#dba2e6", "#76fc1b", "#608fa4", "#20f6ba", "#07d7f6", "#dce77a", "#77ecca"];
  ...
  constructor() ERC721 ("ColorNFT", "COLOR") {
    console.log("This is my NFT Color Generator. Wizard!");
  }
  ...
  function makeAnEpicNFT() public {
    ...
    string memory finalSvg = string(abi.encodePacked(svgPartOne, randomColor, svgPartTwo));    console.log("\n--------------------");
        ...
        bytes(
            string(
                abi.encodePacked(
                    '{"name": "',
                    randomColor,
                    '", "description": "your 4th dimensional color representation.", "image": "data:image/svg+xml;base64,',
